<?php
	...
	$data = mysqli_query($connect,"select * from status_wo");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Laporan Status Kerja.xls";
		...
		//CVS
		$filename = "Laporan Status Kerja.csv";
		...
		//echo "<a href='../../report/pdf_tbbank.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbbank.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbbank.php');</script>
		<?php
	}
