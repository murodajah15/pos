...
if ($nmkasir == "") {
  if (isset($_POST['check1'])) {
    ...
    $queryh = mysqli_query($connect, "select nokwitansi,tglkwitansi,nojual,nmcustomer,piutang,bayar,if(carabayar='Cash',bayar,0) as cash,
  ...
  if (isset($_POST['check1'])) {
    ...
    $queryh = mysqli_query($connect, "select nokwitansi,tglkwitansi,nojual,nmcustomer,piutang,bayar,if(carabayar='Cash',bayar,0) as cash,
      ...
      if(carabayar='Debit Card',bayar,0) as debit_card,
      if(carabayar='Credit Card',bayar,0) as credit_card,
      piutang-bayar as sisa_piutang from kasir_tunai where proses='Y' and user_input='$nmkasir' order by tglkwitansi");
  } else {
    $tanggal = $tanggal1 . ' s/d ' . $tanggal2;
    $queryh = mysqli_query($connect, "select nokwitansi,tglkwitansi,nojual,nmcustomer,piutang,bayar,if(carabayar='Cash',bayar,0) as cash,
      if(carabayar='Transfer',bayar,0) as transfer,
      ...
      if(carabayar='Debit Card',bayar,0) as debit_card,
      if(carabayar='Credit Card',bayar,0) as credit_card,
      piutang-bayar as sisa_piutang from kasir_tunai where proses='Y' and user_input='$nmkasir' and (tglkwitansi>='$tgl1' and tglkwitansi<='$tgl2') order by tglkwitansi");
    //echo $tgl1.'  '.$tgl2;
  }
}
...
<tr><td height="20px" width="150" align="center">&nbsp;( ' . $nmkasir . '&nbsp;)</td>
</tr></table>';
