<?php
	...
	while ($row = mysqli_fetch_assoc($queryh))	{
		$html .= '<tr>
			<td colspan="6" width="573px" height="35px" align="left">&nbsp;'."No. terima : ".$row["noterima"].', Tanggal : '.date('d-m-Y', strtotime($row["tglterima"])).', No. Referensi : '.$row["noreferensi"].', Biaya Lain : '.$row["biaya_lain"].', Penerima : '.$row["penerima"].'</td>';
