<?php
	...
	if ($nmkasir=="") {
		if (isset($_POST['check1'])) {
			...
			$queryh = mysqli_query($connect,"select nokwitansi,tglkwitansi,nojual,nmcustomer,piutang,bayar,
	...
	while ($row = mysqli_fetch_assoc($queryh))	{
		...
		while ($d=mysqli_fetch_assoc($queryd)){
			...
			$html .= '<tr><td align="center">&nbsp;'.$nod.'</td>
								<td>&nbsp;'.$d["nojual"].'</td>
		...
		$html .= '<tr><td colspan="3" height="20px" align="left">&nbsp;'."Total".'&nbsp;</td>
	...
	$html .= '<tr><td colspan="3" height="20px" align="left">&nbsp;'."Grand Total".'&nbsp;</td>
