...
if ($aksesok == 'Y') {
	...
	$tahun = $tgl['year']; ?>
	<font face="calibri">
		<h3>Laporan Purchase Order Barang</h3>
		<hr size="10px">
		<!-- <form method='post' target='_blank' action='report/rpo_pdf.php'> -->
		<!--checked ="checked"-->
		<form method='post' target='_blank' action='report/rpo_xls.php'>
			<!--checked ="checked"-->
			<input type='checkbox' class='form-control' name='check2' value='outstanding'> Outstanding<br>
