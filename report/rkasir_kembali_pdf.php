<?php
	...
	if (isset($_POST['check1'])) {
		...
		$query = mysqli_query($connect,"select * from kasir_kembali where proses='Y'");
	}else{
		$tanggal = $tanggal1.' s/d '.$tanggal2;
		$query = mysqli_query($connect,"select * from kasir_kembali where proses='Y' and tglkwitansi>='$tgl1' and tglkwitansi<='$tgl2'");
	}
	...
	$html = '<style>
		...
		<font size="2"><br><p><center>LAPORAN KASIR PENGEMBALIAN</p>
