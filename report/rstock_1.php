		...
		<font face="calibri">
			...
			<div class='col-md-6'>
				...
				<div class="row">
					...
					<br>
					Pilihan : <input type="radio" name="pilihan" id='perbarang' value="Perbarang" onchange="checkall_barang();" <?php echo 'checked'?>> Perbarang
					<input type="radio" name="pilihan" id='semua_barang' value="Semua" onchange="checkall_barang();"> Semua Barang
					<br><br>
