<form method='post' target='_blank' action='rkasir_tagihan_export.php'>
  <?php
  ...
  ?>
    <input type='checkbox' style='display:none;' name='carabayar' value="carabayar" checked='checked'>
  <?php
  } else {
  ?>
    <input type='checkbox' style='display:none;' name='carabayar' value="carabayar">
  <?php
  }
  ?>
