<?php
	...
	$query = mysqli_query($connect,"select * from kasir_keluarh where nokwitansi='$nokwitansi'");
...
<tr><td>No. Kwitansi</td> <td> <input type=text class='form-control' name='noajukan' value=<?php echo "'$de[nokwitansi]'"?> readonly></td></tr>
<tr><td>Tgl. Kwitansi</td> <td> <input type=text class='form-control' name='tglajukan' value=<?php echo "'$de[tglkwitansi]'"?> readonly></td></tr>
<tr><td>Jenis Pengeluaran</td> <td> <input type="text" class='form-control' id='ppn' name='ppn' size='50' value='<?= $jnkeluar ?>' readonly></td></tr>
