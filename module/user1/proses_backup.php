...
?>
	<p align="center">Data berhasil di Backup ke : <?php echo $path . $database . '-' . $today . '.sql' ?></p>
	...
	<!-- <p align="center"><a style="cursor:pointer" onclick="location.href='download_backup.php?nama_file=test'" title="Download">Download file database</a></p> -->


	<script>
		alert('Data berhasil di Backup '.$path.$database.
			'-'.$today.
			".sql");
		//history.go(-1)
	</script>
