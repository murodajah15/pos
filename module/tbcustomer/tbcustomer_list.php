    ...
    if($_GET['tipe']=='tambah'){
      ...
      if ($lakses == 1) {?>
        ...
        <form method='post' name='tbcustomer' enctype='multipart/form-data' action='module/tbcustomer/proses_tambah.php'>
	        ...
	        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
	          ...
	          <tr><td>Maksimum Piutang</td> <td> <input type='number' class='form-control' name='mak_piutang' required></td></tr>
					</table>
				</div>
				<div class='col-md-12'>
      ...
      echo "<script>alert('Anda tidak berhak !');history.go(-1) </script>";
	        ...
	        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
	          ...
	          <tr><td>Maksimum Piutang</td> <td> <input type='number' class='form-control' name='mak_piutang' value='<?= $mak_piutang ?>'required></td></tr>
					</table>
				</div>
						<div class='col-md-12'>
