<body>
	...
	$query = mysqli_query($connect, "select * from tbcustomer where id='$_GET[id]'");
	$row = mysqli_fetch_array($query);
	$kdcustomer = $row['kode'];
	$query = $connect->prepare("select * from jualh where kdcustomer=?");
	...
	$query = $connect->prepare("delete from tbcustomer where id=?");
