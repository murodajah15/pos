		...
		<?php
			...
			while($k=mysqli_fetch_assoc($tampil)){
				echo "<tr>
					...
					?>
					<td><u><a href="#" data-toggle="modal" data-target="#VModal<?php echo $k['id']; ?>"><font color='blue'><?php echo $k['kode']; ?></font></a></u></td>
					<?php
					echo "<td>$k[nama]</td>
					<td>$k[user]</td>
					<td align='center' width='120px'>";
					?>
						<a href="#" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal<?php echo $k['id']; ?>">Edit</a>
					<?php
						cekakses($connect,$user,'Tabel Bank');
						...
						if ($lakses == 1) {
							...
							echo " <input button type='Button' class='btn btn-danger btn-xs' value='Hapus' onClick='alert_hapus($k[id])'/>";
						}else{
							echo " <input button type='Button' class='btn btn-danger btn-xs' value='Hapus' onClick='alert_hapus($k[id])' disabled/>";
						}
					echo "</td></tr>";
				$no++;
				?>
				<div class="modal fade" id="VModal<?php echo $k['id']; ?>" role="dialog">
              	<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form role="form" action="module/tbbank/proses_edit.php" method="post">
								<?php
								$id = $k['id']; 
				...
				<div class="modal fade" id="myModal<?php echo $k['id']; ?>" role="dialog">
              	<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
