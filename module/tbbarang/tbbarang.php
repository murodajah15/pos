						...
						<tr><td width='100px'>Satuan</td> <td> <input type='text' class='form-control' name='nmsatuan' id='nmsatuan' readonly></td></tr>-->
							...
							<div class='col-md-6'>
								<table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
									<tr>
										<td>Harga Jual</td>
										<td> <input type='number' class='form-control' id='harga_jual' name='harga_jual' onkeyup="validAngka_no_titik(this)"></td>
									</tr>
									<tr>
										<td>Harga Beli</td>
						...
						<form method='post' name='tbbarang' enctype='multipart/form-data' action='module/tbbarang/proses_edit.php'>
							...
							<div class='col-md-6'>
								<table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
									<tr>
										<td>Harga Jual</td>
										<td> <input type="number" class="form-control" name="harga_jual" value="<?= $harga_jual ?>" onkeyup="validAngka_no_titik(this)"></td>
									</tr>
									<tr>
										<td>Harga Beli</td>
										<td> <input type="number" class="form-control" name="harga_beli" value="<?= $harga_beli ?>" readonly></td>
	...
	?>
				...
				<div class="panel-body">
					...
					<span class='glyphicon glyphicon-search'></span> Cari</button> -->
							<div class="col-md-12 bg">
								...
								?>
								<br>
								<font color="red">Field Karakter tidak boleh mengandung " (kutip), silahkan ganti dengan '' (petik 2x)</font>
							</div>
						</div>
					</form>
					</br>
		...
		<table class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">-->
					<div class="box-body table-responsive">
						<table id="tbbarang" class="table table-bordered table-striped">
							<thead>
								<tr>
									<th width='80'>Kode</th>
		...
		<script>
			function alert_proses() {
				swal({
						title: "Yakin Proses Salin ke Tabel Multi Price?",
						text: "",
						icon: "warning",
						buttons: true,
						dangerMode: true,
					...
					.then((willDelete) => {
						if (willDelete) {
							$href = "module/tbbarang/proses_salin.php";
							//window.open($href);
