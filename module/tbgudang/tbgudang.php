				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form method='post' enctype='multipart/form-data'>
							...
							<input button type='Button' class='btn btn-danger' value='Close' onClick="window.location.href='?m=tbgudang'" />
					</div>
				</div>
				</form>
			</font>
...
if (isset($_GET['tipe'])) {
					...
					<form method='post'>
						<div class="row">
							<div class="col-md-12 bg">
								<a class="btn btn-danger" href="?m=tbgudang&tipe=tambah">Tambah data</a>
								<a class="btn btn-success" href="?m=tbgudang&tipe=import">Import data</a>
								<a class="btn btn-warning" href="?m=tbgudang&tipe=export">Export data</a>
							</div>
						</div>
					</form>
					</br>
	...
	<table class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">-->
					...
					<td align='center' width='120px'>
						<a class='btn btn-info' href='?m=tbgudang&tipe=edit&id=$k[id]'>Edit</a>";
								cekakses($connect, $user, 'TABEL GUDANG');
