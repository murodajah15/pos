<?php
	...
	$data = mysqli_query($connect,"select kode,nama from tbgudang");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Gudang.xls";
		...
		//echo "<a href='../../report/pdf_tbgudang.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbgudang.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbgudang.php');</script>
		<?php
	}
