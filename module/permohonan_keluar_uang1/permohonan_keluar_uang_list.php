        ...
        <font face='calibri'>
	        ...
	        <div class='panel-body'>
					...
					<table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
						...
						</td><td><input type="number" class='form-control' id='total' name='total' value='<?= $uang ?>' style='width: 8em'></td>
						</table>
					</div>
					<div class='col-md-12'>
    ...
    if(isset($_GET['tipe'])){
      if($_GET['tipe']=='tambah'){
        ...
        <div class='panel-body'>
		      ...
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
						<tr><td>Nomor Permohonan</td><td>
						<input type='text' class='form-control' id='nomohon' name='nomohon' placeholder='No. Order *' style='text-transform:uppercase;text-align:left' value="<?php echo autoNumber($connect,'id','mohklruangh');?>"  readonly></td></tr>
		      ...
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
      			...
      			<table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
							...
							<tr><td>Materai</td> <td> <input type="number" class='form-control' id='materai' name='materai' size='50' onkeyup="hit_subtotal()" onblur="hit_subtotal()"></td></tr>
							<tr><td>Total</td> <td> <input type="number" class='form-control' id='total' name='total' size='50'></td></tr>
					</table>
				</div>
				<div class='col-md-6'>
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
			        ...
			        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
			      	...
			      	<table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
								<tr><td>Subtotal</td> <td> <input type="number" class='form-control' id='subtotal' name='subtotal' size='50' value='<?=$subtotal?>' readonly></td></tr>
										<tr><td>Materai</td> <td> <input type="number" class='form-control' id='materai' name='materai' size='50' value='<?=$materai?>' onkeyup="hit_subtotal()" onblur="hit_subtotal()"></td></tr>
										<tr><td>Total</td> <td> <input type="number" class='form-control' id='total' name='total' value='<?=$total?>' size='50'></td></tr>
								</table>
							</div>
  						<div class='col-md-6'>
			        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
