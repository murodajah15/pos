<?php
	...
	$data = mysqli_query($connect,"select kode,nama,keterangan from tbjntrans");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Jenis Transaksi.xls";
		...
		//CVS
		$filename = "Tabel Jenis Transaksi.csv";
		...
		//echo "<a href='../../report/pdf_tbjntrans.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbjntrans.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbjntrans.php');</script>
		<?php
	}
