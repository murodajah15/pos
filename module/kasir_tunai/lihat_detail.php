...
<table style=font-size:13px; class='table table-striped table table-bordered'>
	...
	<tr>
		<td>Nilai Bayar</td>
		<td align='right'> <input type="number" class='form-control' id='bayar' name='bayar' size='50' value="<?= $bayar ?>" style='text-align:right' onkeyup="hit_subtotal()" onblur="hit_subtotal()" required readonly></td>
	</tr>
	<tr>
		<td>Uang diterima </td>
		<td> <input type="number" class='form-control' id='uang' name='uang' size='65' value="<?= $uang ?>" style='text-align:right' onkeyup="hit_subtotal()" onblur="hit_subtotal()" required readonly></td>
	<tr>
		<td>Kembali </td>
