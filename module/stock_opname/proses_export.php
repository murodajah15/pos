<?php
	...
	$data = mysqli_query($connect,"select * from tbcustomer");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Customer.xls";
		...
		//echo "<a href='../../report/pdf_tbcustomer.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbcustomer.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbcustomer.php');</script>
		<?php
	}
