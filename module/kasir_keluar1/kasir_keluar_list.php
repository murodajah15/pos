    ...
    if($_GET['tipe']=='tambah'){
      ...
      if ($lakses == 1) {?>
        ...
        <div class='panel-body'>
		      ...
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
					<tr><td>Nomor Kwitansi</td><td>
					<input type='text' class='form-control' id='nokwitansi' name='nokwitansi' id='nokwitansi' placeholder='No. Kwitansi *' style='text-transform:uppercase' value="<?php echo autoNumber($connect,'id','kasir_keluarh');?>" readonly></td></tr>
