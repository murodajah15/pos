...
$id = $_POST['id'];
$query = mysqli_query($connect, "select * from kasir_tagihan where id='$id'");
$de = mysqli_fetch_assoc($query);
?>
<div class="row">
  <div class='col-md-12'>
    <form method='post' enctype='multipart/form-data' action='module/kasir_tagihan/batal_proses.php'>
      <input type="hidden" class='form-control' name='id' id='id' value=<?= $id ?> readonly>
      <label for="nama" class="form-label mb-1">No. Kwitansi Tagihan</label>
