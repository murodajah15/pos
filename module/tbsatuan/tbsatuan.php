				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form method='post' enctype='multipart/form-data'>
							...
							<input button type='Button' class='btn btn-danger btn-sm' value='Close' onClick="window.location.href='?m=tbsatuan'" />
					</div>
				</div>
				</form>
			</font>
...
if (isset($_GET['tipe'])) {
					...
					<form method='post'>
						<div class="row">
							<div class="col-md-12 bg">
								<a class="btn btn-danger btn-sm" href="?m=tbsatuan&tipe=tambah">Tambah data</a>
								<a class="btn btn-success btn-sm" href="?m=tbsatuan&tipe=import">Import data</a>
								<a class="btn btn-warning btn-sm" href="?m=tbsatuan&tipe=export">Export data</a>
							</div>
						</div>
					</form>
					</br>
	...
	<table class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">-->
					...
					<td align='center' width='120px'>
						<a class='btn btn-info btn-sm' href='?m=tbsatuan&tipe=edit&id=$k[id]'>Edit</a>";
								cekakses($connect, $user, 'Tabel Satuan');
