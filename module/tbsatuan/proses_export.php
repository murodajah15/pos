<?php
	...
	$data = mysqli_query($connect,"select kode,nama from tbsatuan");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Satuan.xls";
		...
		//echo "<a href='../../report/pdf_tbsatuan.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbsatuan.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbsatuan.php');</script>
		<?php
	}
