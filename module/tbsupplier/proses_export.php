<?php
	...
	$data = mysqli_query($connect,"select * from tbsupplier");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Supplier.xls";
		...
		//echo "<a href='../../report/pdf_tbsupplier.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbsupplier.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbsupplier.php');</script>
		<?php
	}
