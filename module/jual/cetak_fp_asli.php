<?php
  ...
  if($_SESSION['login']==1){
	...
	$html .= ''."$nm_perusahaan".'
		...
		<table table-layout="fixed"; cellpadding="0"; cellspacing="0"; style=font-size:10px; class="table table-striped table table-bordered;">
			<tr>
				<th width="30px" height="10"><font size="1" color="black">NO.</th>
				<th width="80px"><font size="1" color="black">KD. BARANG</th>
				<th width="361px"><font size="1" color="black">NAMA BARANG</th>
	...
	while ($row = mysqli_fetch_assoc($queryd)){
		...
		$html .= '<tr><td align="center" height="10">'.$no.'</td>
	...
	$html .= '<table table-layout="fixed"; cellpadding="0"; cellspacing="0"; style=font-size:11px; class="table table-striped table table-bordered;">
			<tr>
				<th width="150px"><font size="1" color="black" align="center">Penerima.</th>
				<th width="167px"><font size="1" color="black" align="center">Hormat Kami</th>
				<th width="245px"><font size="1" color="black" align="center">Barang-barang tsb diatas telah diterima/diperiksa dengan baik dan ukuran cukup</th>
				<th width="94px"><font size="1" color="black" align="center" colspan="2"></th><th></th>
			</tr>
			...
			<tr><td align="center">DALAM WAKTU 7 (TUJUH) HARI,<td width="50" align="left">&nbsp;Total</td><td width="50" align="right">'.$ntotal.'&nbsp;</td></tr>
			<tr><td align="center">SETELAH BARANG DITERIMA</td><td colspan="2"></td></tr>
			<tr><td align="center">Nama Terang & Cap Perusahaan</td><td align="center">'.$nm_perusahaan.'&nbsp;</td><td></td><td colspan="2"></td></tr>';
