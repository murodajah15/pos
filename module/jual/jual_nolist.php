...
<!-- 						<tr><td>Nomor Penerimaan</td><td>
  ...
  if(isset($_GET['tipe'])){
    if($_GET['tipe']=='detail'){
        ...
        <div class='panel-heading'><font size="4">TAMBAH DATA DETAIL PENJUALAN</font></div>
        <div class='panel-body'>
		      ...
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
			    ...
			    <th>Aksi</th>
					...
					</td><td><input type="text" class='form-control' id='qty' name='qty' style='width: 6em' onkeyup="validAngka(this)" onblur="hit_subtotal()"></td>
				...
				<font face='calibri'>
					...
					<form method='post' enctype='multipart/form-data' action='module/jual/proses_edit_detail.php'>
						...
						<input type='hidden' name='nojual' value='<?= $nojual ?>'>
 						<table class="table table-bordered table-striped table-hover">
						<tr><td>Nomor Penerimaan</td><td>
						<input type='text' class='form-control' id='nojual' name='nojual' placeholder='No. WO *' style='text-transform:uppercase' value="<?= $nojual ?>" readonly></td>
						</table>
						<table class="table table-bordered table-striped table-hover">
							<td><div class='input-group'>  <input type='text' class='form-control' id='kdbarang' name='kdbarang' value='<?= $kdbarang ?>' size='50' autocomplete='off' readonly required>
								<!--<span class='input-group-btn'>
								<button type='button' id='src' class='btn btn-primary' onclick='cari_data_barang()'>
									Cari
								</button>
							</span></td>-->
							</td><td><input type='text' class='form-control' style='width: 15em' id='nmbarang' name='nmbarang' value='<?= $nmbarang ?>' readonly></td>
							</td><td><input type='text' class='form-control' style='width: 5em' id='kdsatuan' name='kdsatuan' value='<?= $kdsatuan ?>' readonly></td>
							</td><td><input type="text" class='form-control' id='qty' name='qty' value='<?= $qty ?>' style='width: 6em' required onkeyup="validAngka(this)" onblur="hit_subtotal()"></td>
							...
							</td><td><input type="number" class='form-control' id='subtotal' name='subtotal' value='<?= $subtotal ?>' style='width: 10em' readonly></td>
							</table>
  ...
  if(isset($_GET['tipe'])){
    if($_GET['tipe']=='tambah'){
      ...
      if ($lakses == 1) {?>
        <font face='calibri'>
        <div class='panel panel-danger'>
        <div class='panel-heading'><font size="4">TAMBAH DATA PENJUALAN</font></div>
        <div class='panel-body'>
				<form method='post' name='so' enctype='multipart/form-data' action='module/jual/proses_tambah.php'>
				<input type='hidden' name='username' value="<?= $user ?>">
				<div class='col-md-6'>
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
					<tr><td>Nomor Penjualan</td><td>
					<input type='text' class='form-control' id='nojual' name='nojual' id='nojual' placeholder='No. Jual *' style='text-transform:uppercase' value="<?php echo autoNumber($connect,'id','jualh');?>" readonly></td></tr>
					<tr><td>Tgl. (M/D/Y)</td><td><input type='date' class='form-control' id='tgljual' name='tgljual' value="<?php echo $tgl ?>" size='50' autocomplete='off' required readonly></td></tr>
					<tr><td>No. Invoice</td><td><input type='text' class='form-control' id='noinvoice' name='noinvoice' size='50' autocomplete='off' required></td></tr>
					<tr><td>Tgl. Invoice (M/D/Y)</td><td><input type='date' class='form-control' id='tglinvoice' name='tglinvoice' size='50' autocomplete='off' required></td></tr>
					<tr><td>Customer</td> <td><div class='input-group'>  <input type='text' class='form-control' id='kdcustomer' name='kdcustomer' size='50' autocomplete='off' readonly required>
						...
						<tr><td>Biaya Lain</td> <td> <input type="text" class='form-control' name='ket_biaya_lain' id='ket_biaya_lain'></td></tr>
						...
						<tr><td>Tanggal Kirim<br>(M/D/Y)</br></td> <td> <input type="date" class='form-control' name='tglkirim' id='tglkirim' size='50' required></td></tr>
						...
						<tr><td>Sales<td><select id='kdsales' name='kdsales' class='form-control' style='width: 200x;' onchange='changeValueSales(this.value)'>
						<!--<option value=''> - PILIH SATUAN BARANG - </option>";-->
						<?php
	        ...
	        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
						...
						<tr><td>Tempo (Hari)</td> <td> <input type="number" class='form-control' name='tempo' id='tempo' size='50'></td></tr>	
						<tr><td>Tanggal Jatuh Tempo<br>(M/D/Y)</br></td> <td> <input type="date" class='form-control' name='tgl_jt_tempo' id='tgl_jt_tempo' size='50'></td></tr>
			...
			if ($lakses == 1) {	
				...
				<font face='calibri'>
					...
					<div class="panel-heading"><font size="4">EDIT DATA PENJUALAN</font></div>
					<div class="panel-body">
			        ...
			        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
							<tr><td>Nomor Penjualan</td><td>
							<input type='text' class='form-control' id='nojual' name='nojual' placeholder='No. Jual *' style='text-transform:uppercase' value="<?= $nojual ?>" readonly></td></tr>
							<tr><td>Tgl. Penjualan (M/D/Y)</td><td><input type='date' class='form-control' id='tgljual' name='tgljual' value="<?php echo $tgljual ?>" size='50' autocomplete='off' required readonly></td></tr>
								<tr><td>No. Invoice</td><td><input type='text' class='form-control' id='noinvoice' name='noinvoice' value='<?=$noinvoice?>'size='50' autocomplete='off' required></td></tr>
							<tr><td>Tgl. Invoice (M/D/Y)</td><td><input type='date' class='form-control' id='tglinvoice' name='tglinvoice' size='50' value='<?=$tglinvoice?>' autocomplete='off' required></td></tr>
  ...
  <div class="panel panel-info">
    <div class="panel-heading"><font size="4">PENJUALAN</font></div>
    <div class="panel-body">
   	<form method='post'>
		<div class="row">
			<div class="col-md-12 bg">
				<a class="btn btn-danger" href="?m=jual&tipe=tambah">Tambah</a>
				<?php				
	        if ($k['proses']=='Y') {
	...
	<div class="box-body table-responsive">
		<button type='button' id='src' class='btn btn-primary' onclick='cari_data_jual()'>Cari</button>
		<?php
			if (isset($nojual)) {
				echo "<input type='text' class='form-control' id='nojual' name='nojual' autocomplete='off' readonly>";
			}else{
				echo "<input type='text' class='form-control' id='nojual' name='nojual' autocomplete='off'>";
			}
		?>
        ...
        <font face='calibri'>
		      ...
		      <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
						<tr><td>Nomor Penjualan</td><td>
						<input type='text' class='form-control' id='nojual' name='nojual' id='nojual' placeholder='No. Jual *' style='text-transform:uppercase' readonly></td></tr>
						<tr><td>Tgl. (M/D/Y)</td><td><input type='date' class='form-control' id='tgljual' name='tgljual' readonly></td></tr>
						<tr><td>No. Invoice</td><td><input type='text' class='form-control' id='noinvoice' name='noinvoice' readonly></td></tr>
						<tr><td>Tgl. Invoice (M/D/Y)</td><td><input type='date' class='form-control' id='tglinvoice' name='tglinvoice' readonly></td></tr>
						<tr><td>Customer</td><td><input type='text' class='form-control' id='kdcustomer' name='kdcustomer' autocomplete='off' readonly></td></tr>
						<tr><td></td><td><input type="text" class='form-control' id='nmcustomer' name='nmcustomer' readonly ></td></tr>
						<tr><td>Jenis Order<td><input type="text" class='form-control' id='jenis_order' name='jenis_order' readonly ></td></tr>
						<tr><td>Biaya Lain</td><td><input type="text" class='form-control' name='ket_biaya_lain' id='ket_biaya_lain' readonly></td></tr>
						<tr><td></td><td><input type="number" class='form-control' name='biaya_lain' id='biaya_lain' readonly></td></tr>
						<tr><td>Tanggal Kirim<br>(M/D/Y)</br></td> <td> <input type="date" class='form-control' name='tglkirim' id='tglkirim' readonly></td></tr>
						<tr><td>Gudang<td><input type="text" class='form-control' id='kdgudang' name='kdgudang' readonly></td></tr>
						<tr><td></td><td><input type='hidden' class='form-control' size='50' id='nmgudang' name='nmgudang' readonly></td></tr>
						<tr><td>Sales<td><input type="text" class='form-control' id='kdsales' name='kdsales' readonly></td></tr>
						<tr><td></td><td><input type='hidden' class='form-control' size='50' id='nmsales' name='nmsales' readonly></td></tr>		
					</table>
				</div>
				<div class='col-md-6'>
	        <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
						<tr><td>Sales<td><input type="text" class='form-control' id='carabayar' name='carabayar' readonly></td></tr>
						<tr><td>Tempo (Hari)</td> <td> <input type="number" class='form-control' name='tempo' id='tempo' readonly></td></tr>	
						<tr><td>Tanggal Jatuh Tempo<br>(M/D/Y)</br></td> <td> <input type="date" class='form-control' name='tgl_jt_tempo' id='tgl_jt_tempo' readonly></td></tr>
						<tr><td>Subtotal</td> <td> <input type="number" class='form-control' name='subtotal' id='subtotal' readonly></td></tr>
						<tr><td>Total Sementara</td> <td> <input type="number" class='form-control' id='total_sementara' name='total_sementara' readonly></td></tr>
	        	<tr><td>PPn</td> <td> <input type="number" class='form-control' name='ppn' id='ppn' readonly></td></tr>
						<tr><td>Materai</td> <td> <input type="number" class='form-control' name='materai' id='materai' readonlt></td></tr>			
						<tr><td>Total</td> <td> <input type="number" class='form-control' name='total' id='total' readonly></td></tr>
						<tr><td>Keterangan</td><td><textarea type='text' rows='2' class='form-control' id='kerangan' name='keterangan' readonly></textarea></td></tr>
					</table>
				</div></div></form></font>
		</div>
		<?php
			$url = 'http://pinasthika.com'; // Hanya Contoh
			$html = file_get_contents($url);
			$dom = new DOMDocument();
			libxml_use_internal_errors(true);
			$dom->loadHTML($html);
			libxml_clear_errors();
			$id = $dom->getElementById('nojual')->getAttribute('value');
			echo $id;		
		?>
	<?php
	}else{
