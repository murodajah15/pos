...
$id = $_GET['id'];
$who = "Update-" . $_SESSION['username'] . "-" . date('d-m-Y H:i:s') . $_SESSION['norek1'];
...
if ($logo <> "") {
	...
	// $html .= '<table border="0"><tr><td rowspan="4"><img src="../../img/'."$logo".'" width="50"></td><td width="400">'.$nm_perusahaan.'</td><td width="300" align="right">FAKTUR PENJUALAN</td><tr><td><font size="1">'.$alamat_perusahaan.'<br>'.$telp_perusahaan.'</font></td></tr></table>';
...
$html .= '<table border="1" height="15" style="font-size:11px"; table-layout="fixed"; cellpadding="0"; cellspacing="0"; class="table table-striped table table-bordered;">	
			...
			<tr><td align="center">KOMPLAIN/PENUKARAN BARANG<td width="40" align="left">&nbsp;PPN</td><td width="50" align="right">' . $rp_ppn . '&nbsp;</td></tr>
...
$html .= '</table>';
$html .= '<span style="color: black; font-size: 7px;">'.$_SESSION["norek1"].', '.$_SESSION["norek2"].'</span>';
