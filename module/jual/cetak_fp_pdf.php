<?php
  ...
  if($_SESSION['login']==1){
	...
	$html .= '<table border="1" height="15" style="font-size:11px"; table-layout="fixed"; cellpadding="0"; cellspacing="0"; class="table table-striped table table-bordered;">	
			...
			<tr><td rowspan="4"></td><td rowspan="4"></td><td align="center">KAMI HANYA MELAYANI<td width="40" align="left">&nbsp;Subtotal</td><td width="50" align="right"><font size="4">'.$subtotal.'&nbsp;</td></tr>
			<tr><td align="center">KOMPLAIN/PENUKARAN BARANG<td width="40" align="left">&nbsp;Biaya Lain</td><td width="50" align="right" ><font size="4">'.$biaya_lain.'&nbsp;</td></tr>
			<tr><td align="center">DALAM WAKTU 7 (TUJUH) HARI,<td width="50" align="left">&nbsp;PPn '.$nppn.'%</td><td width="80" align="right"><font size="4">'.$ppn.'&nbsp;</td></tr>
			<tr><td align="center">SETELAH BARANG DITERIMA</td><td colspan="1">&nbsp;Total</td><td width="80" align="right"><font size="4">'.$ntotal.'&nbsp;</td></tr>
			<tr><td style="font-size:11px" align="center" width="180">Nama Terang & Cap Perusahaan</td><td style="font-size:11px" align="center" width="170"><font size="3">'.$nm_perusahaan.'&nbsp;</td><td></td><td colspan="2"></td></tr>';	
	$html .='</table>';
