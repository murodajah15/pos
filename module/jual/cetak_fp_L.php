...
if ($jumrecord > 12) {
  ...
  $html .= '<br><p align="center"><u>LAMPIRAN FAKTUR PENJUALAN</u></p>';
  $html .= '<table border="0" table-layout="fixed"; cellpadding="0"; cellspacing="0"; style=font-size:17px; class="table table-striped table table-bordered;">
				<tr><td width="20"></td><td width="100" style="font-size:15px;">' . "Customer" . "</td><td width=650 style=font-size:15px;>: $nmcustomer" . '</td>
				<td width="50"></td><td width="200" style="font-size:12px";>NO. ' . "$nojual" . '</td>
				<tr><td width="20"><td width="100" style="font-size:14px;">' . "Alamat" . "</td>:<td style=font-size:12px;>: $alamatcust" . '</td>
				<td width="50"><td width="200" style="font-size:13px";>' . "$tanggal" . '</td>
				<tr><td width="20"></td><td width="100" style="font-size:15px;">' . "" . "</td><td width=650 style=font-size:15px;>  $kotacust" . '</td>
				<tr><td width="20"></td><td width="100" style="font-size:15px;">' . "Telp." . "</td><td width=650 style=font-size:15px;>: $telpcust" . '</td>
				</table>';
  ...
  $jumrecord = mysqli_num_rows($queryd);
  $html .=
    '<br><table border="1" table-layout="fixed"; cellpadding="1"; cellspacing="1"; style=font-size:17px; class="table table-striped table table-bordered;">
		<thead>
				<tr>
				<td width="20px"></td>
				<td width="40px"><font size="2">No.</td>
				<td width="310px" align="left"><font size="2">NAMA BARANG</td>
				<td width="30px" align="right"><font size="2">SATUAN</td>
				<td width="64px" align="right"><font size="2">QTY</td>
				<td width="93px" align="right"><font size="2">HARGA</td>
				<td width="10px"></td>
				<td width="45px" align="right"><font size="2">DISCOUNT</td>
				<td width="100px" align="right"><font size="2">SUBTOTAL</td>
			</thead>
			</tr>';
  while ($row = mysqli_fetch_assoc($queryd)) {
    ...
    $html .= '<tr>
						...
						<td width="100px" align="right" height="10"><font size="2">' . $subtotal . "&nbsp;" . '</td>
					</tr>';
    $no++;
  ...
  $html .= '<div style="line-height:170%;"></div>';
  $html .= '<table border="0" table-layout="fixed"; cellpadding="0"; cellspacing="0"; style=font-size:17px; class="table table-striped table table-bordered;">
		<tr>
		<td width="20px" height="0"><font size="1"></td>
		...
		<td width="25px" align="center" height="0"><font size="1"></td>
		<td width="80px" align="center"><font size="1"></td></tr>';
  $html .= '<tr><td colspan=6></td><td width="110px" align="right"><font size="2">Total</td><td width="135" align="right"><font size="2">' . $subtotal . '&nbsp;</td></tr>
						<tr><td colspan=6></td><td width="110px" align="right"><font size="2">PPN</td><td width="135" align="right"><font size="2">' . $ppn . '&nbsp;</td></tr>
						<tr><td colspan=6></td><td width="110px" align="right"><font size="2">Grand Total</td><td width="135" align="right"><font size="2">' . $ntotal . '&nbsp;</td></tr>';
  $html .= '</table>';
