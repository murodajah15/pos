    ...
    <div class="panel-body">
		...
		<?php
			...
			if (empty($_GET['kata'])){
				...
				$cari = $_GET['kata'];
				$tampil = mysqli_query($connect,"SELECT * FROM tbcustomer WHERE (kode like '%$cari%' or nama like '%$cari%' or alamat like '%$cari%') order by kode desc LIMIT ".$limit_start.",".$limit);
			}
			if ($page==1) {
				$posisi=0;
				$_GET['halaman']=1;
		...
		<?php
			if (empty($_GET['kata'])){
				...
				$cari = $_GET['kata'];
				$query = mysqli_query($connect,"select count(*) as jumrec from tbcustomer WHERE (kode like '%$cari%' or nama like '%$cari%' or alamat like '%$cari%')");
			}
		...
		<ul class="pagination">
			...
			?>
			  <li><a href="dashboard.php?m=tbmultiprc&kata=<?= $kata ?>&page=1">First</a></li>
			  <li><a href="dashboard.php?m=tbmultiprc&kata=<?= $kata ?>&page=<?php echo $link_prev; ?>">&laquo;</a></li>
			<?php
			}
			?>
			<!-- LINK NUMBER -->
			...
			if (empty($_GET['kata'])){
				...
				$cari = $_GET['kata'];
				$tampil = mysqli_query($connect,"SELECT * FROM tbcustomer WHERE (kode like '%$cari%' or nama like '%$cari%' or alamat like '%$cari%') order by kode desc ");
			}
			...
			?>
			  <li<?php echo $link_active; ?>><a href="dashboard.php?m=tbmultiprc&kata=<?= $kata ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
			<?php
			}
			?>
			...
			if($page == $jumlah_page){ // Jika page terakhir
			  ...
			  $link_next = ($page < $jumlah_page)? $page + 1 : $jumlah_page;
				?>
			  <li><a href="dashboard.php?m=tbmultiprc&kata=<?= $kata ?>&page=<?php echo $link_next; ?>">&raquo;</a></li>
			  <li><a href="dashboard.php?m=tbmultiprc&kata=<?= $kata ?>&page=<?php echo $jumlah_page; ?>">Last</a></li>
			<?php
			}
			?>
		</ul>
