<?php
	...
	$data = mysqli_query($connect,"select kode,nama,initial,telp1,telp2,alamat,kota,kdpos,keterangan from tbnegara");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Sales.xls";
		...
		//echo "<a href='../../report/pdf_tbnegara.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbnegara.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbnegara.php');</script>
		<?php
	}
