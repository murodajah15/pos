<?php
	...
	$data = mysqli_query($connect,"select kode,nama from tbmove");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Perputarang Barang.xls";
		...
		//CVS
		$filename = "Tabel Perputarang Barang.csv";
		...
		//echo "<a href='../../report/pdf_tbmove.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbmove.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbmove.php');</script>
		<?php
	}
