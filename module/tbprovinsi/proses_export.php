<?php
	...
	$data = mysqli_query($connect,"select kode,nama from tbprovinsi");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Provinsi.xls";
		...
		//echo "<a href='../../report/pdf_tbprovinsi.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbprovinsi.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbprovinsi.php');</script>
		<?php
	}
