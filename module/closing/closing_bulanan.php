<?php
  ...
  <div class="panel panel-info">
    <div class="panel-heading"><font size="4">CLOSING BULANAN</font></div>
						...
						<div class='col-md-4'>
							<table class="table table-bordered table-striped table-hover">
								...
								<tr><td>Tahun Periode </td><td>
									...
									<tr><td>Bulan Periode Berikutnya </td>
								...
								<tr><td>Tahun Periode Berikutnya</td><td>
									<?php
									$month=date('m')+1;
									$now=date('Y');
									if ($month>12) {
							...
							<?php
								cekakses($connect,$user,'Closing Bulanan');
