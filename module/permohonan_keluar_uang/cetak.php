...
$queryh = mysqli_query($connect, "select * from mohklruangh where id='$id' and proses='Y' order by nomohon");
$de = mysqli_fetch_assoc($queryh);
$nomohon = $de['nomohon'];
$tanggal = tgl_indo($de['tglmohon']); // $de['tglkwitansi'];
...
// 	</style>';
$html .= '<p style="margin-top:5px; margin-bottom:5px" align="center"><u>PERMOHONAN KELUAR UANG</u></p>
		<hr style="width:99%;text-align:left;margin-left:0">';
$html .= '<table border="0" height="5">			<tr><td width="30" style="font-size:12px;">NO.</td><td width="280" style="font-size:13px";>: ' . "$nomohon" . '</td>
...
$queryd = mysqli_query($connect, "select * from mohklruangd where nomohon='$nomohon' order by nomohon");
$html .= '<table table-layout="fixed"; cellpadding="0"; cellspacing="0"; class="table table-striped table table-bordered;">
		<tr><th width="40px" height="15" align="center"><font size="4" color="black">NO.</th>
			<th width="90px" align="left"><font size="4" color="black">&nbsp;Dokumen</th>
			<th width="70px" align="center"><font size="4" color="black">&nbsp;Tanggal</th>
			<th width="250px" align="left"><font size="4" color="black">Supplier/Customer</th>
			<th width="165px" align="left"><font size="4" color="black">&nbsp;Keterangan</th>
			<th width="80px" align="right"><font size="4" color="black">Jumlah&nbsp;</th></tr>';
while ($row = mysqli_fetch_assoc($queryd)) {
	...
	$html .= '<tr><td width="30px" align="center">' . $no . '</td>
			...
			<td width="200px" align="left">' . "" . $row["kdsupplier"] . '-' . $row["nmsupplier"] . '</td>
			<td width="165x" align="left">' . "&nbsp;" . $row["keterangan"] . '</td>
			<td width="80px" align="right"><font size="5">' . $uang . "&nbsp;" . '</font></td>
			</tr>';
	$no++;
}
