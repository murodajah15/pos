<?php
	...
	$data = mysqli_query($connect,"select kode,nama from tbjnbrg");
	
	if($_POST['typefile']=='Excel'){
		//Excel
		$filename = "Tabel Jenis Barang.xls";
		...
		//CVS
		$filename = "Tabel Jenis Barang.csv";
		...
		//echo "<a href='../../report/pdf_tbjnbrg.php' target='_blank'>Cetak</a><br><br>";
		//header("location:../../report/pdf_tbjnbrg.php");
		?>
		<script type="text/javascript" language="Javascript">window.open('../../report/pdf_tbjnbrg.php');</script>
		<?php
	}
