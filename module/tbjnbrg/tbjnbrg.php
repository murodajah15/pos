			...
			<font face='calibri'>
				<div class="panel panel-success">
					<div class="panel-heading">
						<font size="4">IMPORT DATA TABEL JENIS BARANG</font>
					</div>
					<div class="panel-body">
						<form method='post' enctype='multipart/form-data' action='module/tbjnbrg/proses_import.php'>
		...
		if ($lakses == 1) { ?>
			<font face='calibri'>
				<div class="panel panel-default">
					<div class="panel-heading">
						<font size="4">EXPORT DATA TABEL JENIS BARANG</font>
					</div>
					<div class="panel-body">
						<form method='post' enctype='multipart/form-data' action='module/tbjnbrg/proses_export.php'>
							<input type='hidden' name='username' value='<?= $user ?>'>
...
if (isset($_GET['tipe'])) {
	if ($_GET['tipe'] == 'detail') {
		...
		if ($lakses == 1) {
			// $query = $connect->prepare("select * from tbjnbrg where id=?");
			...
			$sql = mysqli_query($connect, "select * from tbjnbrg where id='$_GET[id]'");
		...
		?>
			<font face='calibri'>
				<div class="panel panel-default">
					<div class="panel-heading">
						<font size="4">DETAIL DATA TABEL JENIS BARANG</font>
					</div>
					<div class="panel-body">
		...
		if ($lakses == 1) { ?>
			<font face='calibri'>
				<div class='panel panel-danger'>
					...
					<div class='panel-body'>
						<form method='post' name='tbjnbrg' enctype='multipart/form-data' action='module/tbjnbrg/proses_tambah.php'>
							<input type='hidden' name='username' value="<?= $user ?>">
		...
		?>
			<font face="calibri">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<font size="4">EDIT DATA TABEL JENIS BARANG</font>
					</div>
					<div class="panel-body">
						<form method="post" enctype="multipart/form-data" action="module/tbjnbrg/proses_edit.php">
							<input type="hidden" name="username" value="<?= $user ?>">
							<input type="hidden" name="id" value="<?= $de["id"] ?>">
							<table style=font-size:13px; class="table table-striped table table-bordered">
								<tr>
	...
	?>
		<font face="calibri">
			<div class="panel panel-info">
				<div class="panel-heading">
					<font size="4">TABEL JENIS BARANG</font>
				</div>
				<div class="panel-body">
					<form method='post'>
						<div class="row">
	...
	<table class="table table-bordered table-striped table-hover" cellspacing="0" width="100%">-->
					<div class="box-body table-responsive">
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php
							$tampil = mysqli_query($connect, "SELECT * FROM tbjnbrg order by kode");
							$no = 1;
							while ($k = mysqli_fetch_assoc($tampil)) {
								echo "<tr>
					<td align='center'>$no</td>
					<td><u><a href='?m=tbjnbrg&tipe=detail&id=$k[id]'><font color='blue'>$k[kode]</font></a></u></td>
					<td>$k[nama]</td>
					<td>$k[user]</td>
				...
				function alert_hapus($id) {
					swal({
						...
						.then((willDelete) => {
							if (willDelete) {
								//alert($kode);
								$href = "module/tbjnbrg/proses_hapus.php?id=";
